...
class plugin_info
{
    ...
    static $PLUGIN_CODE = "CartMessageSelectBox";

    /** プラグイン名(必須)：プラグイン管理・画面出力（エラーメッセージetc）にはこの値が出力されます。 */
    static $PLUGIN_NAME = "お問い合わせ選択プラグイン";

    /** プラグインメインクラス名(必須)：本体がプラグインを実行する際に呼ばれるクラス。拡張子は不要です。 */
    static $CLASS_NAME = "CartMessageSelectBox";
    ...
    /** 説明(必須) */
    static $DESCRIPTION = "カートのその他お問い合わせを選択形式に変換するプラグインです。";
